...
function create_card(game) {
    ...
    ps_icon.innerHTML = `<i class="fa-brands fa-playstation text-2xl"></i>`;
    xbox_icon.innerHTML = `<i class="fa-brands fa-xbox text-2xl"></i>`;
    win_icon.innerHTML = `<i class="fa-brands fa-windows text-2xl"></i>`;
    ...
    fav_icon.innerHTML = `<i class="fa-regular fa-heart items-end text-4xl"></i>`
    //game title
    ...
    icon_holder.appendChild(fav_icon);
    //adding element to card
    card.appendChild(game_img);
    card.appendChild(icon_holder);
...
async function add_cards() {
    ...
    try {
        ...
        console.log("a problem while loading the games")
    }
}
